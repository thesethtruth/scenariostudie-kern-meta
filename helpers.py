...
def load_costs(
    tech_costs, config, elec_config, year, Nyears=1.0, legacy_gt_to_hydrogen=[]
):
    ...
    if legacy_gt_to_hydrogen:
        for gt in legacy_gt_to_hydrogen:
            ...
            try:
                costs.at[
                    gt, "fuel"
                ]  # raises KeyError if user did not specify costs for this technology
                costs.at[gt, "fuel"] = 0
            except KeyError:
                pass
